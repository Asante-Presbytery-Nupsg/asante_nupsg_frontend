...
export function ColumnVisibilityDropdown<T>({
  ...
  return (
    <div className="relative group">
      ...
      <div className="absolute left-0 md:left-auto md:right-0 mt-1 w-56 bg-white border border-gray-200 rounded-lg shadow-lg opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all z-10">
